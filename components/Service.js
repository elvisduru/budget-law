...
const StyledService = tw.div`flex flex-row py-6 border-b border-gray-50 border-opacity-5 px-6 last-of-type:(border-0) hocus:(bg-gray-900) lg:(py-10 last-of-type:(border-b))`
